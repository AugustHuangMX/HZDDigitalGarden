...
| Day 4 | **Causal Part 2 + Weak IV + ML**              | 1. 完成 Otsu PS4 Q3(c-d)（Control Function / Selection Model）— 40min                                                                                   | Heckman 两步法思路：$E[Y                                                                                                                                                                       | W,X,Z] = \tau W + X'\beta + \rho_1 W\frac{\phi}{\Phi} + \rho_2(1-W)\frac{\phi}{1-\Phi}$；endogenous treatment |                                                          |
