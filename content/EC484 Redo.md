...
| 2019 ST | Q3(a)-(e)      | 内生性 Probit：控制函数法（control function），含 $\theta$ 推导、两步估计、假设检验 | 暴露的更多的是假设检验的不熟悉。                                 |     |
...
| 年份      | 题号         | 考点                                                    | 做后感                |
| ------- | ---------- | ----------------------------------------------------- | ------------------ |
| 2018 ST | Q3(b)      | IPW 证明：$E[y_1] = E\left[\frac{wy}{p(x)}\right]$（17 分） | 考察的是 Causal 课件里的原题 |
