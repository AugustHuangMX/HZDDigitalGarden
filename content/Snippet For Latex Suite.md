...
{trigger: "Var", replacement: "\\text{Var}", options: "mA"},
{trigger: "Cov", replacement: "\\text{Cov}", options: "mA"},
{trigger: "Corr", replacement: "\\text{Corr}", options: "mA"},

// 条件期望和概率
{trigger: "EE[", replacement: "\\mathbb{E}[$0]$1", options: "mA"},
{trigger: "EE|", replacement: "\\mathbb{E}[$0 | $1]$2", options: "mA"},
{trigger: "PP|", replacement: "\\mathbb{P}($0 | $1)$2", options: "mA"},
...
{trigger: "argmax", replacement: "\\arg\\max", options: "mA"},
{trigger: "argmin", replacement: "\\arg\\min", options: "mA"},

// 带下标的最优化
{trigger: "\\max", replacement: "\\max_{$0} $1", options: "m"},
{trigger: "\\min", replacement: "\\min_{$0} $1", options: "m"},
{trigger: "\\argmax", replacement: "\\arg\\max_{$0} $1", options: "m"},
{trigger: "\\argmin", replacement: "\\arg\\min_{$0} $1", options: "m"},

// ============ 常用下标（经济学/计量经济学）============

{trigger: "xtt", replacement: "x_{t}", options: "mA"},
{trigger: "ytt", replacement: "y_{t}", options: "mA"},
{trigger: "xit", replacement: "x_{it}", options: "mA"},
{trigger: "yit", replacement: "y_{it}", options: "mA"},
{trigger: "t-1", replacement: "_{t-1}", options: "mA"},
{trigger: "t+1", replacement: "_{t+1}", options: "mA"},

// ============ 估计量和统计符号 ============

{trigger: "hatt", replacement: "\\hat{$0}", options: "mA"},
{trigger: "barr", replacement: "\\bar{$0}", options: "mA"},
{trigger: /b([0-9])/, replacement: "\\beta_{[[0]]}", options: "rmA"},
{trigger: "bhat", replacement: "\\hat{\\beta}", options: "mA"},
{trigger: "yhat", replacement: "\\hat{y}", options: "mA"},

// ============ 收敛符号 ============

{trigger: "pto", replacement: "\\xrightarrow{p}", options: "mA"},
{trigger: "dto", replacement: "\\xrightarrow{d}", options: "mA"},
{trigger: "asto", replacement: "\\xrightarrow{a.s.}", options: "mA"},

// ============ 分布 ============

{trigger: "sim", replacement: "\\sim", options: "mA"},
{trigger: "iid", replacement: "\\overset{\\text{i.i.d.}}{\\sim}", options: "mA"},
{trigger: "Norm", replacement: "\\mathcal{N}", options: "mA"},
{trigger: "norm(", replacement: "\\mathcal{N}($0, $1)", options: "mA"},
...
{trigger: "such", replacement: "\\text{s.t.}", options: "mA"},
...
{trigger: "lrp", replacement: "\\left( $0 \\right)", options: "mA"},
{trigger: "lrb", replacement: "\\left[ $0 \\right]", options: "mA"},
{trigger: "lrc", replacement: "\\left\\{ $0 \\right\\}", options: "mA"},

// ============ 数学环境增强 ============

{trigger: "eqn", replacement: "\\begin{equation}\n$0\n\\end{equation}", options: "tAw"},
{trigger: "eqnn", replacement: "\\begin{equation*}\n$0\n\\end{equation*}", options: "tAw"},
{trigger: "split", replacement: "\\begin{split}\n$0\n\\end{split}", options: "mA"},

// ============ 常用函数 ============

{trigger: "sgn", replacement: "\\text{sgn}", options: "mA"},
{trigger: "plim", replacement: "\\text{plim}", options: "mA"},
{trigger: "rank", replacement: "\\text{rank}", options: "mA"},
